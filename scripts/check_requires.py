...
aa `requires` pointing at a renamed/deleted resource would make the installer silently skip a dependency
...
def load_resource_keys() -> set[str]:
    ...
    # Print success message with inspected count
    if keys:
