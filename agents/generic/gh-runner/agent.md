...
- #287  feat(admin): bulk invite UI                       Alex     2d ago   ✓ checks
- #285  fix(billing): tax calc rounding                   Sam      4h ago   ✗ 1/12 failed
- #284  refactor: drop check-environments end-to-end      Alex     1d ago   ⊙ pending
- ... +4 more
```
...
**Author:** Alex Kim  •  **State:** open  •  **Branch:** feature/admin-bulk-invite → main
**Checks:** ✓ 12/12 passing  •  **Reviews:** 1 approval (Sam), 0 changes requested
