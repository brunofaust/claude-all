...
| Evaluating Python 3.14 free-threaded builds, when to use, pros/cons, implementation with `InterpreterPoolExecutor`, and dependency compatibility checks | [`references/free-thread-python-3.14.md`](references/free-thread-python-3.14.md) |
