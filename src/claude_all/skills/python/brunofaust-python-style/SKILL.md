...
| Reference hook config — a complete, commented `prek.toml` wiring every gate above (repo hygiene + Python toolchain + this skill's `checkers/`), ready to copy to a repo root                   | [`prek.toml`](prek.toml)                                                                                |
