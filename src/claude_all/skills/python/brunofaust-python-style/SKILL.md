...
| Writing/optimizing async code — TaskGroup, ExceptionGroup, `run_in_thread`, semaphores, rollback, FIFO, pagination, `InterpreterPoolExecutor`                                                                             | [`references/async-patterns.md`](references/async-patterns.md)                                          |
| Choosing between the GIL and free-threaded 3.14 builds — when free-threading pays, `sys._is_free_threaded()`, real-race discipline, C-extension / `cp314t` dependency compatibility                                 | [`references/free-threading.md`](references/free-threading.md)                                          |
