...
| Adopting the free-threaded 3.14 build (PEP 703, `--disable-gil` / `python3.14t`) — when it beats `run_in_thread`, pros/cons, enabling and verifying it, checking C-extension wheel (`cp314t`) compatibility; vs PEP 734 subinterpreters (→ async-patterns.md) | [`references/free-thread-python-3.14.md`](references/free-thread-python-3.14.md)                      |
