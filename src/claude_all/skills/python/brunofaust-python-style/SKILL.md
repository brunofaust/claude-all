...
| Using Python 3.14 free-threading (`--disable-gil`) — when to use, pros/cons, implementation, dependency compatibility, platform limits, migration                                            | [`references/free-threading.md`](references/free-threading.md)                                          |
