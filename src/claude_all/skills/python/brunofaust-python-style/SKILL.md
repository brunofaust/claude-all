...
| Python 3.14 free-threading — when to use free-threaded builds for CPU-bound pure Python, pros/cons, implementation, and dependency compatibility checks          | [`references/free-thread-python-3.14.md`](references/free-thread-python-3.14.md)                                        |
