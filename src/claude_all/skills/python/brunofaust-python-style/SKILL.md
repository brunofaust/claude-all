...
| Deciding whether to run **free-threaded Python (no GIL)** — when to adopt `-X gil=0` / `--disable-gil`, pros and cons, how to implement it, and how to prove dependency (wheel) compatibility  | [`references/free-thread-python-3-14.md`](references/free-thread-python-3-14.md)                        |
