...
| Understanding free-threaded Python (no-GIL) build — when to use, pros/cons, implementation, and dependency compatibility | [`references/free-thread.md`](references/free-thread.md)                                                |
