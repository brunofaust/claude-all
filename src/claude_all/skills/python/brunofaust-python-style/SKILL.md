...
| Leveraging Python 3.14 free-threading via `InterpreterPoolExecutor` — when to use, pros/cons, implementation patterns, compatibility checking                                               | [`references/free-thread-python-3.14.md`](references/free-thread-python-3.14.md)                        |
