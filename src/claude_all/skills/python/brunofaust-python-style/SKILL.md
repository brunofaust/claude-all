...
| Writing/optimizing CPU-bound parallel code — free-threading, subinterpreters, and when to use each                           | [`references/free-threading.md`](references/free-threading.md)                               |
