...
msg="$(code-review-graph status --repo "/Users/bfaust/Library/CloudStorage/OneDrive-Personal/Documents/My Git/claude-all/.claude/worktrees/feat+compact-context" 2>&1 | head -n 1 || true)"
